                    ...
                    if (command.type === 'message' && command.message) {
                        if (command.message.attributes && command.message.attributes.attachment && command.message.attributes.attachment.json_buttons){
                            ...
                            try {
                                ...
                                console.log("json_buttons:", typeof json_buttons, json_buttons);
    ...
    static async updateRequestAttributes(chatbot, chatbotToken, message, projectId, requestId) {
        ...
        try {
            ...
            if (message.type && message.type === "image" && message.metadata) {
                ...
                //     "src": "https://firebasestorage.googleapis.com/v0/b/chat21-pre-01.appspot.com/o/public%2Fimages%2F8ac52a30-133f-4ee1-8b4b-96055bb81757%2Fda5bbc8d-5174-49a8-a041-3d9355242da5%2Ftiledesk_Open%20graph_general.png?alt=media&token=[REDACTED_TOKEN]",
                //     "type": "image/png",
                //     "uid": "lo68iyq5",
                //     "width": 1724
                // }
            ...
            if (message.type && message.type === "file" && message.metadata) {
                // "type": "file",
                // "text": "[LIBRETTO-WEB-ISTRUZIONI-GENITORI.pdf](https://firebasestorage.googleapis.com/v0/b/chat21-pre-01.appspot.com/o/public%2Fimages%2F8ac52a30-133f-4ee1-8b4b-96055bb81757%2F502265ee-4f4a-47a4-9375-172bb0e6bf39%2FLIBRETTO-WEB-ISTRUZIONI-GENITORI.pdf?alt=media&token=[REDACTED_TOKEN])\nistruzioni",
                // "metadata": {
                //     "name": "LIBRETTO-WEB-ISTRUZIONI-GENITORI.pdf",
                //     "src": "https://firebasestorage.googleapis.com/v0/b/chat21-pre-01.appspot.com/o/public%2Fimages%2F8ac52a30-133f-4ee1-8b4b-96055bb81757%2F502265ee-4f4a-47a4-9375-172bb0e6bf39%2FLIBRETTO-WEB-ISTRUZIONI-GENITORI.pdf?alt=media&token=[REDACTED_TOKEN]",
